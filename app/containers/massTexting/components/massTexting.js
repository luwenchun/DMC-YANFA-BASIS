        ...
        <Form>
          ...
          <FormItem {...formItemLayout} label={`群发内容`} style={{ width: '100%' }}>
            ...
            <Row gutter={12}>
              ...
              <Col span={5} style={{ display: formFieldValues.type === 1 || formFieldValues.type == "" ? 'none' : 'block' }}>
          ...
          <FormItem style={{ display: formFieldValues.type == 1 && formFieldValues.type !== "" ? 'block' : 'none' }}
            {...formItemLayout}
            label="内容概要"
          >
