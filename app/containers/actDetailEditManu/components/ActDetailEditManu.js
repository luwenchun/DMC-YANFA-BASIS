    ...
    return (
      <div className='wrap' style={{ 'padding': '12px' }}>
        <Row gutter={12} style={{ textAlign: 'right', paddingBottom: 20 }}>
          <span style={{ display: formFieldValues.dealerCode === '00000' ? 'inline-block' : 'none' }}>
            ...
            <Button type="default" htmlType="button" icon="search" style={{ marginLeft: 8 }} onClick={handlePreview}>预览</Button></span>
          <Button type="primary" htmlType="button" style={{ marginLeft: 8 }} onClick={() => { history.push('../infoManu') }}>返回</Button>
        ...
        <Modal
          ...
          <Form>
            ...
            <FormItem
              ...
              label="显示序号"
            >
              <InputNumber width={80} defaultValue={hotEditData.hotOrder} onChange={v => { this.setState({ hotEditData: Object.assign({}, this.state.hotEditData, { hotOrder: v }) }) }} min={0} max={65535} />
