...
import ActEdit from './components/ActEditDealer';
...
// const ActEditComp=withStyles(s)(ActEditPageWithForm);

// function action({ path, query, hash, Authorization }) {

//   const currentAuthorization = DMCUtil.getCurrent(Authorization)
//   return {
//     chunks: ['act.editDealer'],
//     title,
//     component: (
//       <Layout hide={true}>
//         <ActEditComp currentAuthorization={currentAuthorization} />
//       </Layout>
//     ),
//   };
// }
