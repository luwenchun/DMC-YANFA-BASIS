  ...
  constructor(props) {
    ...
    this.state = {
      ...
      formFieldValues: {
        ...
        "tagId": "",
        "tagName": "",
        // "titleImage": "https://carapptest.gtmc.com.cn/fs01/20180330/16de1ec912369a12488b7699a138c2b0.jpg",
        "titleImage": "",
      },
      editDiff: {
        editType: 'add',
 ...
 */
  ...
  */
  verification() {
    ...
    for (let k in obj) {
      if (activityType === "enter" && Object.prototype.toString.call(obj[k]) === "[object Object]") {
        let isPass = true;
      ...
      <div className='wrap' style={{ 'padding': '12px' }}>
        <Form>
          ...
          >
            <RichText
              richOpt={richOpt}
              defaultValue={formFieldValues.activityContent}
              result={formFieldValues.activityContent}
