...
class Tree extends React.Component {
        ...
        if (nextProps.show) {
            ...
            if (nextProps.data.bizType == '1002') {      // 动态
                ...
                Http.get("getCourseInfo", { id: nextProps.data.id }, (info) => {
                    ...
                    data.bizType = '1002';
                    info ? _this.setState({ visible: true, getCourseInfo: Object.assign({}, data), currentRecord: Object.assign({}, data) }) : '';
                })
                ...
                Http.get('getTopItemInfo', { id: nextProps.data.id }, (res) => {
                    ...
                    _this.setState({ visible: true, getItemInfo: Object.assign({}, data), currentRecord: Object.assign({ bizType }, data) })
                })
            }
            this.setState({ title });
    ...
    render() {
        ...
        const getCourseInfo = <Form>
            <div style={{ marginTop: '-24px', display: currentRecord.dealerCode === '00000' ? 'block' : 'none' }}>
                <Popconfirm
                    placement="bottom"
